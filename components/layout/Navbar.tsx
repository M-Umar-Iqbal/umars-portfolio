...
const navigation = [
    ...
    { name: 'About Me', href: '/about', icon: FaUser, current: false },
    { name: 'My Projects', href: '/projects', icon: FaProjectDiagram, current: false },
    { name: 'Contact', href: '/contact', icon: FaEnvelope, current: false },
    { name: 'Blog', href: '/blog', icon: FaBlog, current: false },
  ];
